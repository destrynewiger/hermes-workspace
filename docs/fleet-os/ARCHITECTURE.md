...
Integrations: Attio (SoT), Gmail, Calendar, Slack, Telegram, LinkedIn, X, Sumble, Apollo, Amplemarket, Common Room, Luma, Granola, Google Trends, GitHub, Tailscale.
...
- Signal engine: normalize Sumble/inbox/etc. into strength-scored signals that enqueue research or drafts.
